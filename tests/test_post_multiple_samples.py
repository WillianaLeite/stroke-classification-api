...
sample_test = pd.DataFrame(data=[[0.020161, 0.326613, 0.531754, 0.073085, 0.046371, 0.002016, 0.034945, 0.225959, 0.555176, 0.145822, 0.038098, 0.0],
                                 [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]], columns=cols)
payload = {'extractor_type': 'percent', 'data': json.dumps(sample_test.values.tolist())}
